...
class TestOne:
    def test_execs_the_built_statement_and_returns_the_one_row(
        self,
        query: BaseQuery,
        session: MagicMock,
    ) -> None:
        ...
        session.exec.return_value.one.return_value = record
        ...
        session.exec.return_value.one.assert_called_once_with()
